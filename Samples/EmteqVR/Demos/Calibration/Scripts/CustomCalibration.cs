...
namespace EmteqLabs
{
    public class CustomCalibration : MonoBehaviour
    {
        ...
        {
            EmteqVRManager.EndDataSection("Main calibration sequence");
        ...
        private void EnableNextExpressionAvatar()
        {
            ...
            else
            {
                ...
                EmteqVRManager.StartDataSection("Main calibration sequence");
        ...
        private IEnumerator HandleCalibrationProgress()
        {
            if (_currentCalibrationStep != 0)
            {
                ...
                EmteqVRManager.StartExpressionCalibration(_calibrationExpressions[_currentCalibrationStep - 1].SelectedExpression);
