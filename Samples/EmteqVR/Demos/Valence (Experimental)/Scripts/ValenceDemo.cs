...
namespace EmteqLabs
{
    public class ValenceDemo : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //To be wired up to SDK 2
            //EmteqVRManager.OnValenceReceived += OnValenceReceived;
        }
        void OnDestroy()
        {
            if (EmteqVRManager.Instance)
            {
                //EmteqVRManager.Instance.OnValenceReceived -= OnValenceReceived;
            }
        }
        ...
        private void StartCalibration()
        {
            ...
            //To be wired up to SDK 2
            //EmteqVRDevice.StartCalibration(_currentType);
        }
        ...
        public void FinishCalibration()
        {
            ...
            //To be wired up to SDK 2
            //EmteqVRDevice.StopCalibration(_currentType);
        }

        public void EnableNormRms()
        {
            //To be wired up to SDK 2
            //EmteqVRDevice.StartNormalisedEmgRms();
        }
